            ...
            <div className="xl:w-4/5 max-w-[650px] space-y-10">
              ...
              <div>
                ...
                <ol className="list-decimal list-inside">
                  ...
                  <li>
                    Users should be able to create a music request for the Dj
                  </li>
                  <li>
                    Minimum of 2 pages
              ...
              <div>
                ...
                <ol className="list-decimal list-inside">
                  ...
                  <li>
                    Reload should&apos;nt be needed for new music requests to be
                    seen
                  </li>
                  <li>
                    The Dj should be able to mark as played or flag as
                    unavailable
                  </li>
                </ol>
              </div>
